...
public class Traversal {
    ...
    private int s, t;
    int[][] w;
    int[] color;    // Các matrix vẫn bắt đầu từ 1
    int []p;    //p[v] = cha của v trong quá trình đi thăm
    int []d;    //d[k] = thời gian ghé thăm đỉnh k
    int []f;    //f[k] = thời gian kết thúc thăm (duyệt) đỉnh k
    int time;   //số bước duyệt, thăm trên toàn đồ thị. Cần khởi tạo = 0 trước khi duyệt
    String []steps;    //steps là thứ tự duyệt node (ko tính node nguồn)
