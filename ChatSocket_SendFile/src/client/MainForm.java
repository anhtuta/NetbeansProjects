...
public class MainForm extends javax.swing.JFrame {
    ...
    */
    public void getMsgHeader(String header, Color color){
        ...
        jTextPane1.setCaretPosition(len);   //thiết lập vị trí để chèn text vào textpane
        jTextPane1.setCharacterAttributes(MessageStyle.styleMessageContent(color, "Impact", 13), false);    //thiết lập kiểu font chữ
        jTextPane1.replaceSelection(header+":");    //chèn text vào vị trí đã thiết lập với kiểu font như trên
    }
    /*
        Message Content
    */
