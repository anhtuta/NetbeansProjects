 ...
 * @author AnhTu
 */
public class PropertiesDemo_Note {
    ...
    public static void main(String args[]) {
        ...
        capitals.put(95, "anhtu"); //ko thể dùng số
        ...
        enumCapitals = capitals.elements();
        ...
        System.out.println("Nhận xét: ko xài đc hàm elements()");
        ...
        System.out.println("Nhận xét: key là số thì ko lấy đc value vì dòng trên ép kiểu sang String rồi");
