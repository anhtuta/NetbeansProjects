...
public class FloorStart extends JPanel {
	/**
	 * 
	 */
	...
	public FloorStart() {
		...
		floor1 = new JLabel(new ImageIcon(this.getClass().getResource("/image/1.png")));
		floor2 = new JLabel(new ImageIcon(this.getClass().getResource("/image/2.png")));
		floor3 = new JLabel(new ImageIcon(this.getClass().getResource("/image/3.png")));
		floor4 = new JLabel(new ImageIcon(this.getClass().getResource("/image/4.png")));
		floor5 = new JLabel(new ImageIcon(this.getClass().getResource("/image/5.png")));
		floor6 = new JLabel(new ImageIcon(this.getClass().getResource("/image/6.png")));
		box.add(floor1);
		box.add(floor2);
		box.add(floor3);
		box.add(floor4);
