...
public class FrameCutMp3 extends JFrame {
	...
	public FrameCutMp3(AudioPlayer audioPlayer) {
		this.audioPlayer = audioPlayer;
		this.setTitle("Frame Cut");
	...
	public void setInformation() {
		if (audioPlayer.getCurrentMusicFile() != null) {
			timeStart.setText("0");
			timeEnd.setText(String.valueOf((int) audioPlayer.getCurrentMusicFile().getTimeEnd()));
		}
	}
